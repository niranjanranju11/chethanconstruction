...
import com.chethanconstruction.auth.JwtAuthenticationFilter;
import com.chethanconstruction.auth.UserRepository;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/mock-storage/**").permitAll()
